#!/bin/bash
export LD_LIBRARY_PATH=/home/cyberyoung/src/zprojects/ketama.svn/libketama/
SERVERFILE="./kengtadie.servers"

echo -en "Checking if hashing works as expected..."

OURHASH=`LD_LIBRARY_PATH=. ./ketama_test ${SERVERFILE} | md5sum | cut -b1-32`

if [ "$OURHASH" != "d5e282e1e9b433ab8517a9f281d2bb06" ]
then
	echo "FAIL"
	exit 1
else
